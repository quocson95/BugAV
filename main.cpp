...
//    SDL_RenderCopyEx(renderer, is->vid_texture, NULL, &rect, 0, NULL, vp->flip_v ? SDL_FLIP_VERTICAL :static_cast<SDL_RendererFlip>(0));
...
//            s->rdft_data = static_cast<float *>(av_malloc_array(nb_freq, 4 *sizeof(*s->rdft_data)));
//        }
...
//                           frame->sample_rate, frame->channels, av_get_sample_fmt_name(static_cast<AVSampleFormat>(frame->format)), buf2, is->auddec.pkt_serial);
...
//{
//    show_mode = static_cast<ShowMode>(!strcmp(arg, "video") ? SHOW_MODE_VIDEO :
