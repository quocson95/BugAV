...
#define FFMPEG_CONFIGURATION "--prefix=/home/sondq/Documents/dev/qt/build-ffmpeg-vcloudcam --disable-doc --disable-debug --enable-shared --enable-runtime-cpudetect --enable-avresample --disable-postproc --enable-pic --extra-cflags='-Wa,--noexecstack -fdata-sections -ffunction-sections -fstack-protector-strong' --extra-ldflags='-Wl,--gc-sections' --enable-small --disable-avresample --disable-filters --enable-filter='*fade,*fifo,*format,*resample,aeval,all*,atempo,color*,convolution,draw*,eq*,framerate,hw*,null,volume,scale' --disable-muxers --disable-encoders --disable-decoders --enable-decoder='*sub*,*text*,*web*,aac*,ac3*,alac*,ape,ass,cc_dec,cook,dca,eac3*,flv,flac,gif,h264*,hevc*,mp[1-3]*,*peg*,mpl2,nellymoser,opus,pcm*,rawvideo,rv*,sami,srt,ssa,v210*,vc1*,vorbis,vp[6-9],wm*,wrapped_avframe' --disable-demuxers --enable-demuxer='*sub*,*text*,*ac3,*ac,*peg*,*web*,ape,ass,avi,concat,dts*,*dash*,*flv,gif,hls,h264,hevc,matroska,mlv,mov,mp3,mxf,nsv,nut,ogg,pcm*,rawvideo,rt*p,spdif,srt,vc1,v210*,wav,*pipe, mpegts' --disable-parsers --enable-parser='*sub*,aac*,ac3,cook,flac,h26[3-5],hevc,*peg*,opus,rv*,vc1,vorbis,vp[8-9]' --enable-encoder='aac,gif,h26[3-5]*,hevc*,mjpeg,mpeg[2-4]*,nellymoser,nvenc*,opus,pcm*,rawvideo,vorbis,vp*,wrapped_avframe' --enable-protocol=https --enable-protocol=http --enable-muxer='dash,fifo,flv,gif,h264,hevc,hls,mjpeg,matroska*,mov,mp4,mpegts,nu*,og*,pcm*,rawvideo,spdif,wav,webm,*pipe,mpegts' --enable-gnutls"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "/home/sondq/Documents/dev/qt/build-ffmpeg-vcloudcam/share/ffmpeg"
#define AVCONV_DATADIR "/home/sondq/Documents/dev/qt/build-ffmpeg-vcloudcam/share/ffmpeg"
#define CC_IDENT "gcc 9.3.0 (Arch Linux 9.3.0-1)"
